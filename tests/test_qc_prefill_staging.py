...
sized to the cache's context, which every two-pass prefill call views instead of allocating.
"""
import sys, os
...
def staged_prefill_case(past, q_len):
...
def window_numel():
    ...
    return 0 if entry is None else entry[0].numel()
