...
class DeepseekVLV2Config(Config):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.max_position_embeddings = self.read_cfg(int, "text_config->max_position_embeddings", 4096)

        self.assert_cfg(str, "text_config->hidden_act", "silu", optional = True)
        self.intermediate_size = self.read_cfg(int, "text_config->intermediate_size", no_default)
        self.first_k_dense_replace = self.read_cfg(int, "text_config->first_k_dense_replace", 0)
        ...
        self.num_shared_experts = self.read_cfg(int, "text_config->n_shared_experts", 0)
        ...
        self.topk_method = self.read_cfg(str, "text_config->topk_method", "greedy")
        self.norm_topk_prob = self.read_cfg(bool, "text_config->norm_topk_prob", False)
