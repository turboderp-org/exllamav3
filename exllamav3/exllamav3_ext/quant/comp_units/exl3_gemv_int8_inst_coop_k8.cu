...
{
    if (c_fp32)  return residual ? (void*) exl3_mgemv_int8_coop_kernel<8, true, true>
                                 : (void*) exl3_mgemv_int8_coop_kernel<8, true, false>;
    else         return residual ? (void*) exl3_mgemv_int8_coop_kernel<8, false, true>
                                 : (void*) exl3_mgemv_int8_coop_kernel<8, false, false>;
}
