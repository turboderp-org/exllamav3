...
{
    if (c_fp32)  return residual ? (void*) exl3_mgemv_int8_coop_kernel<4, true, true>
                                 : (void*) exl3_mgemv_int8_coop_kernel<4, true, false>;
    else         return residual ? (void*) exl3_mgemv_int8_coop_kernel<4, false, true>
                                 : (void*) exl3_mgemv_int8_coop_kernel<4, false, false>;
}
