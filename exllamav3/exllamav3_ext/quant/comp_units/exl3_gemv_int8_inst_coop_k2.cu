...
{
    if (c_fp32)  return residual ? (void*) exl3_mgemv_int8_coop_kernel<2, true, true>
                                 : (void*) exl3_mgemv_int8_coop_kernel<2, true, false>;
    else         return residual ? (void*) exl3_mgemv_int8_coop_kernel<2, false, true>
                                 : (void*) exl3_mgemv_int8_coop_kernel<2, false, false>;
}
